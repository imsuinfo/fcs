...
if (!defined('DRUPAL_ROOT')) {
  define('DRUPAL_ROOT', '/var/www/drupal/sandbox/fcs');
}
...
if ($_SERVER['SERVER_PORT'] == 443) {
  $base_url = 'https://sandbox.mcneese.edu/fcs';  // NO trailing slash!
}
else {
  $base_url = 'http://sandbox.mcneese.edu/fcs';  // NO trailing slash!
}
 ...
 */
$conf['fcs_site_url'] = 'sandbox.mcneese.edu/fcs';
 ...
 * Custom Error Pages
 */
$conf['error_document_file_403'] = '/var/www/error_documents/4xx/fcs_sandbox/403.html';
$conf['error_document_file_404'] = '/var/www/error_documents/4xx/fcs_sandbox/404.html';
$conf['error_document_file_500'] = '/var/www/error_documents/5xx/fcs_sandbox/500.html';
$conf['error_document_file_500-no_database'] = FALSE;
$conf['error_document_file_503'] = '/var/www/error_documents/5xx/fcs_sandbox/503.html';
