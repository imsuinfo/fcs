...
$conf['error_document_custom_menu_1_logged_in'] = '<nav class="menu html_tag-nav">' . "\n" . '  <ul class="navigation_list html_tag-list">' . "\n" . '    <li class="leaf menu_link-wrapper menu_link-wrapper-standout menu_link-create_request-wrapper first"><a class="menu_link menu_link-create_request" href="/requests/create-0" title="Create a New Request">Create Request</a></li>' . "\n" . '    <li class="leaf menu_link-wrapper menu_link-this_month-wrapper"><a class="menu_link menu_link-this_month" href="/requests/calendar-0/month" title="View Calendar for This Month">This Month</a></li>' . "\n" . '    <li class="leaf menu_link-wrapper menu_link-this_day-wrapper"><a class="menu_link menu_link-this_day" href="/requests/calendar-0/day" title="View Calendar for Today">This Day</a></li>' . "\n" . '    <li class="leaf menu_link-wrapper menu_link-facilities_use_information-wrapper"><a class="menu_link menu_link-facilities_use_information" href="https://www.mcneese.edu/facilities/facilitiesuse" title="Facilities Use Information">Facilities Use Information</a></li>' . "\n" . '    <li class="leaf menu_link-wrapper menu_link-my_mcneese-wrapper last"><a class="menu_link menu_link-my_mcneese" href="https://mymcneese.mcneese.edu/" title="Go Back to MyMcNeese Portal">MyMcneese</a></li>' . "\n" . '  </ul>' . "\n" . '</nav>';
