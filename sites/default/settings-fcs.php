...
if (!defined('DRUPAL_ROOT')) {
  define('DRUPAL_ROOT', '/var/www/drupal/fcs');
}
 ...
 * Temporary directory
 **/
$conf['file_temporary_path'] = '/var/www/webfiles/temporary/fcs';
...
$conf['reply_to'] = 'no_reply@fcs.mcneese.edu';
 ...
 * Custom Error Pages
 */
$conf['error_document_file_403'] = '/var/www/error_documents/4xx/fcs/403.html';
$conf['error_document_file_404'] = '/var/www/error_documents/4xx/fcs/404.html';
$conf['error_document_file_500'] = '/var/www/error_documents/5xx/fcs/500.html';
$conf['error_document_file_500-no_database'] = FALSE;
$conf['error_document_file_503'] = '/var/www/error_documents/5xx/fcs/503.html';
$conf['error_document_custom_menu_1_logged_in'] = '<nav class="menu html_tag-nav">' . '  <ul class="navigation_list html_tag-list">' . ' <li class="leaf menu_link-wrapper menu_link-wrapper-standout menu_link-create_request-wrapper first"><a class="menu_link menu_link-create_request" href="/requests/create-0" title="Create a New Request">Create Request</a></li>' . ' <li class="leaf menu_link-wrapper menu_link-this_month-wrapper"><a class="menu_link menu_link-this_month" href="/requests/calendar-0/month" title="View Calendar for This Month">This Month</a></li>' . ' <li class="leaf menu_link-wrapper menu_link-this_day-wrapper"><a class="menu_link menu_link-this_day" href="/requests/calendar-0/day" title="View Calendar for Today">This Day</a></li>' . ' <li class="leaf menu_link-wrapper menu_link-facilities_use_information-wrapper"><a class="menu_link menu_link-facilities_use_information" href="https://www.mcneese.edu/facilities/facilitiesuse" title="Facilities Use Information">Facilities Use Information</a></li>' . ' <li class="leaf menu_link-wrapper menu_link-my_mcneese-wrapper"><a class="menu_link menu_link-my_mcneese" href="https://mymcneese.mcneese.edu/" title="Go Back to MyMcNeese Portal">MyMcneese</a></li>' . ' <li class="leaf menu_link-wrapper menu_link-help-wrapper last"><a class="menu_link menu_link-help" href="/help-0" title="View Online Documentation">Help</a></li>' . '  </ul>' . '</nav>';
